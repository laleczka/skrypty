...
for file=2:1:16%number of VEPs
    %load data with frequency 1000 Hz.
    Fs = 1000;
    load([path_data, rat, '_VEP', num2str(file),  '_1000Hz.mat']) %contains variable all_data
...
%     
%     fileID = fopen([path_data, rat, '_VEP', num2str(file),'.dat']);
